 ...
 * 
 */
class HeaderFullImageBlockService extends BaseBlockService {
  ...
  public function setDefaultSettings(OptionsResolverInterface $resolver) {
    ...
    $resolver->setDefaults(array(
      'template' => 'BRSPineappleBundle:Blocks:header.full-image.html.twig',
      'content' => '<h2>Heading Title</h2><p class="lead">Donec ullamcorper nulla non metus auctor fringilla. Vestibulum id ligula porta felis euismod semper. Praesent commodo cursus magna, vel scelerisque nisl consectetur. Fusce dapibus, tellus ac cursus commodo.</p>',
      'media'    => null,
      'media_title' => null,
      'media_alt' => null,
    ));
